...
export const adminSchemas: Record<string, AdminSchema> = {
  services: {
    ...
    fields: [
      ...
      { key: "image", label: "Hero image path", type: "text", help: "e.g. /images/ga-drawing.jpg (optional)" },
  ...
  industries: {
    ...
    fields: [
      ...
      { key: "title", label: "Title", type: "text" },
      { key: "summary", label: "Summary", type: "textarea" },
      { key: "image", label: "Image path", type: "text", help: "e.g. /images/tekla-model.jpg (optional)" },
  ...
  projects: {
    ...
    fields: [
      ...
      { key: "scope", label: "Scope of work", type: "lines" },
      { key: "challenge", label: "Challenge", type: "textarea" },
      { key: "solution", label: "Solution", type: "textarea" },
      { key: "results", label: "Outcome", type: "textarea" },
